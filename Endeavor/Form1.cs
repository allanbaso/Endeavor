...
namespace Endeavor
{
    public partial class Form1 : Form
    {
        ...
        {
            beginProcedure();
            Properties.Settings.Default.racfid = this.textBox1.Text;
            Properties.Settings.Default.path   = this.textBox4.Text;
        ...
        public void beginProcedure()
        {
            ...
            try
            {
                ...
                PresSpace.WaitForString("CLIENT", 0, 0, 30000, true, false);
                ...
                if (searchText("DEV", PresSpace))
                {
                   ...
                   // PresSpace.SendKeys("s[enter]", row, col - 3);
                    ...
                    if (searchText("Master Application Menu", PresSpace))
                    {
                        ...
                        if (!searchText("environment", PresSpace))
                        {
                            PresSpace.SendKeys("[enter]", PresSpace.CursorPosRow, PresSpace.CursorPosCol);
                            PresSpace.WaitForString("environment", 0, 0, 10000, true, false);
                        }
                        ...
                        PresSpace.SendKeys("Fernando", 14, 19);// se movio
        ...
        {
            textBox1.Text = Properties.Settings.Default.racfid.ToString();
