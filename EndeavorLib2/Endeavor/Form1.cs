                ...
                if (searchText("DEV", PresSpace))
                {
                   ...
                   // PresSpace.SendKeys("s[enter]", row, col - 3);
                    ...
                    if (searchText("Master Application Menu", PresSpace))
                    {
                        ...
                        PresSpace.SendKeys("N", 11, 50);
                        PresSpace.SendKeys("Y", 12, 50);
                        PresSpace.SendKeys("5[enter]", 2, 15);
                        PresSpace.WaitForString("Additional Batch JCL", 0, 0, 7000, true, false);
                        PresSpace.SendKeys("//ARCHIVE DD DSN=AGOTOPR.ENDEVOR.LIBMAN2.ARCHIVE,DISP=MOD", 5, 8);
                        PresSpace.SendKeys("//*", 6, 8);
                        PresSpace.SendKeys("[pf3]", PresSpace.CursorPosRow, PresSpace.CursorPosCol);
                        PresSpace.SendKeys("1[enter]", 2, 15);
                        PresSpace.SendKeys("13[enter]", 2, 15);

                        //PresSpace.SendKeys("5[enter]", PresSpace.CursorPosRow, PresSpace.CursorPosCol);

                        PresSpace.WaitForString("ARCHIVE ELEMENTS", 0, 0, 10000, true, false);
                        ...
                        for (int i = 0; i < words.Length; i++)
                        {
                            if (words[i].Contains('!'))
                            {
                                ...
                                PresSpace.SendKeys("Y", 11, 72);
                                //PresSpace.SendKeys("Y", 15, 72);
